  ...
  return (
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]">
      <header className="row-start-1 flex flex-col items-center gap-4 text-center">
        <h1 className="text-4xl font-bold tracking-tight">TTS Voice Cloning Models Comparison</h1>
        <p className="text-lg text-gray-600 dark:text-gray-400 font-bold">
          Original vs Qwen vs Fish Audio vs ElevenLabs (Normal and Flash) vs Resemble.ai Chatterbox
        </p>
      </header>
